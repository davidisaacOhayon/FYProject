...
townsCoordinates = {
    ...
    "Zurrieq": [35.8347, 14.4744],
    "Luqa": [35.8597, 14.4886],
    "Mqabba": [35.8478, 14.4686],
    "Qrendi": [35.8328, 14.4575],
    "Safi": [35.8336, 14.4847],
    "Marsaxlokk": [35.8419, 14.5431],
    "Kirkop": [35.8425, 14.4853],
    "Gudja": [35.8469, 14.5039],
    "Tarxien": [35.8669, 14.5114],
    "Santa Lucija": [35.8642, 14.5081],
    "Fgura": [35.8736, 14.5242],
    ...
    "Birkirkara": [35.8953, 14.4620],
    "GharGhur": [35.9247, 14.4586],
    "Pembroke": [35.9253, 14.4764],
    "St. Julian's": [35.9186, 14.4891],
    "Valletta": [35.8989, 14.5146],
    "Paola": [35.8736, 14.4983],
    "Marsa": [35.8772, 14.4950],
    "Hamrun": [35.8844, 14.4853],
    "Floriana": [35.8916, 14.5042],
    "Pieta": [35.8947, 14.4922],
    "Santa Venera": [35.8897, 14.4758],
    "Qormi": [35.8764, 14.4726]
}